...
class RightHand: # NOTE: if two distinct hand classes are not necessary, backtrack and re-write this for the general case
    def __init__(self):
        ...
        self.A_opt = np.array([[ 9.97608409e-01, 2.10778462e-04, -1.49185923e-03],
             [ 4.05971955e-04, 9.97381174e-01, 6.25440799e-04],
             [-1.05075931e-03, 1.11144707e-04, 9.97057688e-01]])

        self.B_opt =  np.array([[-0.00050159, -0.01353447, 0.00078104],
             [ 0.01206072, 0.00536319, 0.01698486],
             [ 0.00535402, -0.02057974, -0.0060778 ]])
