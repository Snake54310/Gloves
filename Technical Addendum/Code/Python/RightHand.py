...
class RightHand: # NOTE: if two distinct hand classes are not necessary, backtrack and re-write this for the general case
    def __init__(self):
        ...
        self.A_opt = np.array([[ 9.97906299e-01, -1.19887962e-04, -1.34437927e-03],
            [ 2.70692713e-04, 9.97383926e-01, 3.50895027e-04],
            [-1.04417828e-03, -1.09366246e-04, 9.97172482e-01]])

        self.B_opt =  np.array([[ 0.00037405, -0.01291243, 0.00487449],
            [ 0.01158937, 0.0058908, 0.02793989],
            [ 0.00166242, -0.02423558, -0.00529311]])
