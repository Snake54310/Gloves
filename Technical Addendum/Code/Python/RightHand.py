...
class RightHand: # NOTE: if two distinct hand classes are not necessary, backtrack and re-write this for the general case
    def __init__(self):
        ...
        self.B_opt =  np.array([[-7.80981125e-04, -1.60217561e-02,  4.47967057e-05],
             [ 9.28946558e-03, 4.81889881e-03, 1.51564626e-02],
             [ 5.15995775e-03, -1.88091993e-02, -2.38657004e-03]])
