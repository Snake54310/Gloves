"""
RightHandKinematics.py

Kinematic model of the RIGHT hand.  Identical in structure to
LeftHandKinematics.py; the two files are kept separate so that each can
carry its own hard-coded gyro correction matrices (A_opt, B_opt, b_opt)
and any future per-hand axis remaps without diverging in a single shared file.

See HandKinematics.py (original) for full algorithm documentation.
"""
...
class RightHand:
    """
    Kinematic model of the right hand.
    Gyro correction matrices below are specific to the RIGHT glove hardware.
    """
    ...
    def __init__(self):
        ...
        # ---- RIGHT-GLOVE gyro correction matrices ----
